...
(function(){
	//选择服务器文件CTRL
    materialAdmin.controller('selectServerFileModalCtrl', ['$scope', 'httpLoad', '$modalInstance',
	...
	//新建文件task指令
    materialAdmin.directive('ngFileTask', ['$compile',  function ($compile) {
		return {
			restrict: 'EA',
			scope:{},
	...
	//新建脚本task指令
    materialAdmin.directive('ngScriptTask', ['$compile', '$modal', '$rootScope', function ($compile, $modal, $rootScope) {
		return {
			restrict: 'EA',
			scope:{},
	...
	//新建文件job指令
    materialAdmin.directive('ngFileJob', ['$modal', '$compile', 'httpLoad', function ($modal, $compile, httpLoad) {
		return {
			restrict: 'EA',
			scope:{},
	...
	//新建文件job->添加服务器文件指令
    materialAdmin.directive('ngFileJobAddFile', ['$modal', 'httpLoad', function ($modal, httpLoad) {
		return {
			restrict: 'EA',
			scope:{
				accountData: '='
	...
	//新建脚本job指令
    materialAdmin.directive('ngScriptJob', ['$rootScope','$compile', '$modal', 'httpLoad', '$timeout',  function ($rootScope, $compile, $modal, httpLoad, $timeout) {
		return {
			restrict: 'EA',
			scope:{},
	...
	//新建备份文件task指令
    materialAdmin.directive('ngBackupTask', ['$compile',function ($compile) {
		return {
			restrict: 'EA',
			scope:{},
	...
	//新建备份文件job指令
    materialAdmin.directive('ngBackupJob', ['$modal', '$compile', 'httpLoad', function ($modal, $compile, httpLoad) {
		return {
			restrict: 'EA',
			scope:{},
	...
	//任务页面跳转
    materialAdmin.directive('ngTaskMainRouter', ['$rootScope', 'httpLoad', function ($rootScope, httpLoad) {
		return {
			restrict: 'EA',
			scope:false,
			link: function (scope, element, attrs) {
...
/*	//websocket文件上传指令
    materialAdmin.directive('ngFileUpload', ['$rootScope', '$modal', 'httpLoad', function ($rootScope, $modal, httpLoad) {
		return {
			restrict: 'EA',
			scope: false,
			link: function (scope, element, attrs) {
...
//任务预览
    materialAdmin.directive('ngExcuteDetail', [function () {
		return {
			restrict: 'EA',
...
//任务执行结果
    materialAdmin.directive('ngExcuteResultDetail', ['httpLoad', 'webSocket', '$modal', function (httpLoad, webSocket, $modal) {
		return {
			restrict: 'EA',
...
//执行job详情
    materialAdmin.directive('ngExecuteJobDetail', ['httpLoad', 'webSocket', '$interval', function (httpLoad, webSocket, $interval) {
		return {
			restrict: 'EA',
...
//在线编辑指令
    materialAdmin.directive('ngCodeMirror', [function () {
		return {
			restrict: 'EA',
			scope:{
				codeMirror: '='
...
//在线编辑指令->只适用于显示只读
    materialAdmin.directive('ngCodeMirror2', ['$timeout',function ($timeout) {
		return {
			restrict: 'EA',
			scope:{
				data:'=',
	...
	//对指令元素操作指令
    materialAdmin.directive('ngHandleDom', ['$rootScope', '$modal', '$timeout', function ($rootScope, $modal, $timeout) {
		return {
			restrict: 'EA',
			scope:{},
			link: function (scope, element, attrs) {
	...
	//job元素拖拽操作
    materialAdmin.directive('ngDragJob', ['$rootScope', '$timeout', function ($rootScope, $timeout) {
		return {
			restrict: 'EA',
			scope:{},
			link: function (scope, element, attrs) {
    ...
    materialAdmin.directive('ngDragModal', ['$rootScope',  function ($rootScope) {
		return {
			restrict: 'EA',
			scope:{},
			link: function (scope, element, attrs) {
	...
	//任务类的验证
    materialAdmin.directive('ngValidatorPopover', ['$rootScope',  function ($rootScope) {
		return {
			restrict: 'EA',
			scope:{
				$invalid:'='
	...
	// -------------------------任务改版-------------------------------------
	//任务页面跳转
    materialAdmin.directive('ngTaskMainRouterCopy', ['$rootScope', 'httpLoad', function ($rootScope, httpLoad) {
		return {
			restrict: 'EA',
			scope:false,
			link: function (scope, element, attrs) {
	...
	//在线编辑指令->任务改版
    materialAdmin.directive('ngCodeMirrorCopy', ['$timeout', function ($timeout) {
		return {
			restrict: 'EA',
			scope:{
				codeMirror: '='
	...
	/*//任务详情预览
    materialAdmin.directive('ngTaskPreviewDetail', [function () {
		return {
			restrict: 'EA',
	...
	//任务执行详情
/*    materialAdmin.directive('ngTaskExecuteDetail', ['httpLoad', 'webSocket', '$modal', function (httpLoad, webSocket, $modal) {
		return {
			restrict: 'EA',
