...
(function(){
	app.controller('CustomEsLogCtrl', ['$rootScope', '$scope','$modal','$state', 'httpLoad', 
		...
		$scope.reset = function(){
			var obj = ['datecondition','indexcondition','typecondition','logflagcondition','hostcondition','loglevelcondition','messagecondition','custom','customcondition','customvalue','date','index','type','logflag','host','loglevel','message'];
