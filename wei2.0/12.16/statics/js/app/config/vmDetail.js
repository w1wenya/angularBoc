angular.module('app').controller('detailVmModalCtrl', ['$rootScope', '$scope','$state','httpLoad','$stateParams',function($rootScope, $scope,$state,httpLoad,$stateParams) {
    ...
    $scope.goBack = function(){
        ...
        sessionStorage.setItem('vmtabLocation', JSON.stringify('vmDetail'));
    };
}]);