...
(function(){
	"use strict";
	app.controller('LogSourceRecordCtrl', ['$scope', 'httpLoad', '$rootScope','$modal','$timeout','$state','$stateParams','LANGUAGE',
		function($scope, httpLoad, $rootScope, $modal, $timeout, $state, $stateParams, LANGUAGE) {
			$rootScope.moduleTitle = '参数管理 > 日志配置下发记录';//定义当前页
			$scope.param = {
				page: 1,
				rows: 10,
			...
			$scope.goDetail = function(id){
				$state.go('app.config.sourcerecorddetail',{id:id})
			};
