angular.module('app').controller('detailHostMonitorModalCtrl', ['$rootScope', '$scope','$interval','$state','httpLoad','$stateParams',function($rootScope, $scope,$interval,$state,httpLoad,$stateParams) {
