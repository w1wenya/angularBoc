...
(function(){
	"use strict";
	app.controller('TaskTplCtrl', ['$scope', 'httpLoad', '$rootScope','$modal','$timeout','$state',
		function($scope, httpLoad, $rootScope, $modal, $timeout, $state) {
			$rootScope.moduleTitle = '日常作业 > 作业编排';//定义当前页
			$scope.param = {
				page: 1,
				rows: 10,
			...
			$scope.reset = function(){
				var obj = ['name','creator','date','mender','createrId','menderId'];
