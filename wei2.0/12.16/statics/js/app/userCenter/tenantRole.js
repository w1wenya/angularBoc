angular.module('app').controller('tenantRoleCtrl', ['$rootScope', '$scope','$state','httpLoad','$stateParams','LANGUAGE',function($rootScope, $scope,$state,httpLoad,$stateParams,LANGUAGE) {
