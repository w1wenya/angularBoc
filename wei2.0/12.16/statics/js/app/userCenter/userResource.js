(function(){
    "use strict";
    app.controller('userResourceCtrl', ['$scope', 'httpLoad', '$rootScope','$modal','$state', '$stateParams','LANGUAGE',
        function($scope, httpLoad, $rootScope, $modal, $state, $stateParams, LANGUAGE) {
            ...
            $scope.selectServer = function(){
                var modalInstance = $modal.open({
                    templateUrl: '/statics/tpl/userCenter/user/bindModal.html',
                    controller: 'bindUserModalCtrl',
                    backdrop: 'static',
                    size:'lg'
                });
    ...
    //删除
    angular.module('app').controller('removeuserModalCtrl', ['$scope', '$modalInstance', 'httpLoad', 'removeData',
    ...
    //新增绑定
    app.controller('bindUserModalCtrl', ['$scope','httpLoad','$modalInstance','$stateParams',
