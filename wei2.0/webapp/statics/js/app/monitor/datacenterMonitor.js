angular.module('app').controller('detailDatacenterMonitorModalCtrl', ['$rootScope', '$scope','$interval','$state','httpLoad','$stateParams',function($rootScope, $scope,$interval,$state,httpLoad,$stateParams) {
