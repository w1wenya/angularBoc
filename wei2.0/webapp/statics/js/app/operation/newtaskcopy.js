...
(function () {
	...
	app.controller('addScriptTaskModalCtrl', ['$scope', '$modalInstance', '$modal', '$stateParams', '$timeout', 'httpLoad',  'node',
	...
	app.controller('addFileTaskModalCtrl', ['$scope', '$modalInstance', '$modal', '$stateParams', '$timeout', 'httpLoad',  'node',
		function ($scope, $modalInstance, $modal, $stateParams, $timeout, httpLoad, node) {
			$scope.itemsByPage = 5;//目标服务器每页显示条数
			node = angular.fromJson(node);
			if($stateParams.flag == 10 || $stateParams.flag == 11) $scope.hideTarget = true;
	...
	app.controller('addBackupTaskModalCtrl', ['$scope', '$modalInstance', '$modal', '$stateParams', '$timeout', 'httpLoad',  'node',
		function ($scope, $modalInstance, $modal, $stateParams, $timeout, httpLoad, node) {
			$scope.itemsByPage = 5;//目标服务器每页显示条数
			node = angular.fromJson(node);
			if($stateParams.flag == 10 || $stateParams.flag == 11) $scope.hideTarget = true;
