    ...
    .run([
      ...
      function ($templateCache) {
        $templateCache.put('template/treeGrid/treeGrid.html',
          ...
          "       </td>\n" +
          "       <td ng-if='actionData'>" +
          "       <a ng-repeat='item in actionData' style='margin-right:5px' href='javascript:void(0)' ng-hide='item.flag == 1&&row.branch.type == \"beans\"' ng-click='user_clicks_action({flag:item.flag,item:row.branch})' ng-bind='item.name'></a>\n" +
          "     </tr>\n" +
          "   </tbody>\n" +
          " </table>\n" +
          "</div>\n" +
